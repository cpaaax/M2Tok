...
DINOSigLIP_VISION_BACKBONES = {
    ...
    # },
"dinosiglip-vit-so-224px": {
        "dino": "vit_large_patch14_reg4_dinov2.lvd142m", # /mnt/workspace/hf_models/vit_large_patch14_reg4_dinov2.lvd142m
        "siglip": "vit_so400m_patch14_siglip_224",
        # "siglip": "/mnt/workspace/hf_models/vit_so400m_patch14_siglip_224",
    },
...
class DinoSigLIPViTBackbone(VisionBackbone):
    def __init__(self, vision_backbone_id: str, image_resize_strategy: str, default_image_size: int = 224) -> None:
        ...
        self.dino_featurizer: VisionTransformer = timm.create_model(
            ...
            pretrained_cfg_overlay={'file': '/cpfs01/user/xuchunpu/hf_models/timm/vit_large_patch14_reg4_dinov2.lvd142m/model.safetensors'}
        )
        self.dino_featurizer.eval()

        self.siglip_featurizer: VisionTransformer = timm.create_model(
            self.siglip_timm_path_or_url, pretrained=True, num_classes=0, img_size=self.default_image_size,
            pretrained_cfg_overlay={'file': '/cpfs01/user/xuchunpu/hf_models/timm/ViT-SO400M-14-SigLIP/open_clip_model.safetensors'}
        )
