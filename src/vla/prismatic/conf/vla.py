...
@dataclass
class Exp_Tokenflow_224px_Bridge(VLAConfig):
    vla_id: str = "tokenflow-224px+Qwen0.5b+mx-bridge"
    base_vlm: Union[str, Path] = "/cpfs01/user/xuchunpu/embodied_codes/Show-o-main_mine/show-o-tuning-stage1/checkpoint-8721/unwrapped_model"
    vision_tower: Union[str, Path] = "/oss-xuchunpu/train_tokenflow_weights/results_tokenizer_image/002-TokenFlow/checkpoints/1035000.pt"
...
class VLARegistry(Enum):
    ...
    # Tokenflow
    TOKENFLOW_224PX_QWEN_500M = Exp_Tokenflow_224px_Bridge
